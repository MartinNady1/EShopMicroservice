...
{
    [DbContext(typeof(ApplicationDbContexct))]
    partial class ApplicationDbContexctModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Ordering.Domain.Models.Order", b =>
                {
                    ...
                    b.OwnsOne("Ordering.Domain.Models.Address", "BillingAddress", b1 =>
                        {
                    ...
                    b.OwnsOne("Ordering.Domain.Models.Address", "ShippingAddress", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Ordering.Domain.Models.Payment", "Payment", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uuid");
